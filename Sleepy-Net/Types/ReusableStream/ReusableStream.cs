...
namespace Sleepy
{
    ...
    public partial class ReusableStream : Stream
    {
        ...
        {
            int readCount = Math.Min(count, UnreadByteCount);
        ...
        {
            int byteCount = BytesRequiredForVarInt(value);
        ...
        public ulong ReadVarUInt()
        {
            ...
            byte lastByte = data[pos];
            ulong value = (ulong)(lastByte & 0x7F);
            pos++;
        ...
        void WriteVarIntImpl(ulong value, int byteCount, int pos)
        {
            ...
            int endMinusOne = pos + byteCount - 1;
